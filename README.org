...
for_window [class="TelegramDesktop"] floating enable, resize set 930 1020, move position 525 30
for_window [class="Alacritty"] floating enable, resize set 1200 800, move position 380 140
#+end_src
...
exec_always --no-startup-id setxkbmap -layout us,ru -variant -option grp:alt_shift_toggle,grp_led:scroll
...
#exec --no-startup-id "sleep 45; i3-msg 'workspace 3; exec intellij-idea-community'"
...
#+begin_src conf :tangle ~/.config/i3/config
exec_always --no-startup-id chmod +x $HOME/.config/polybar/polybar.sh
...
for_window [app_id="mpv"] resize set 800 600
for_window [app_id="telegram-desktop_telegram-desktop"] floating enable
for_window [app_id="telegram-desktop_telegram-desktop"] resize set 930 1020
for_window [app_id="gnome-terminal-server"] floating enable
for_window [app_id="gnome-terminal-server"] resize set 1200 800
#for_window [class="GParted"] floating enable border normal
#+end_src
