...
bindsym $alt+c exec --no-startup-id exec emacsclient -c -n
...
exec --no-startup-id "sleep 10; i3-msg 'workspace 1; exec /snap/bin/emacsclient -c -n -a \"\" -e \"(dired nil)\"'"
exec --no-startup-id "sleep 13; i3-msg 'workspace 2; exec /snap/bin/emacsclient -c -n -a \"\" -e \"(bk/switch-to-dashboard)\"'"
# exec --no-startup-id "sleep 18; i3-msg 'workspace 3; exec ~/idea/bin/idea.sh'"
exec --no-startup-id "sleep 18; i3-msg 'workspace 3; exec ~/idea_new_ui/bin/idea.sh'"
exec --no-startup-id "sleep 2; i3-msg 'workspace 4; exec firefox'"
exec --no-startup-id "sleep 15; i3-msg 'workspace 5; exec /snap/bin/emacsclient -c -n -a \"\" -e \"(telega)\"'"
...
bindsym $mod+Return exec /home/solus/.cargo/bin/alacritty
...
bindsym $alt+v exec --no-startup-id emacsclient -c -n -e "(multi-vterm)"
...
# IDEA
bindsym $alt+i exec --no-startup-id ~/idea_new_ui/bin/idea.sh
#+end_src
...
# exec --no-startup-id "sleep 10; swaymsg 'workspace 1; exec /snap/bin/emacsclient -c -n -a \"\" -e \"(dired nil)\"'"
# exec --no-startup-id "sleep 13; swaymsg 'workspace 2; exec /snap/bin/emacsclient -c -n -a \"\" -e \"(bk/switch-to-dashboard)\"'"
# exec --no-startup-id "sleep 18; swaymsg 'workspace 3; exec ~/idea_new_ui/bin/idea.sh'"
exec --no-startup-id "sleep 10; swaymsg 'workspace 3; exec ~/idea_new_ui/bin/idea.sh'"
