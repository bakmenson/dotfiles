...
for_window [class="Alacritty"] floating enable, resize set 1200 800
...
# exec --no-startup-id "sleep 10; swaymsg 'workspace 3; exec ~/idea/bin/idea.sh'"
...
exec --no-startup-id "sleep 9; swaymsg 'workspace 5; exec telegram-desktop'"
