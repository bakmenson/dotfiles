...
## Type: ShellCommand
c.editor.command = ['xfce4-terminal', 'nvim', '-f', '{file}', '-c', 'normal {line}G{column0}l']
...
c.url.start_pages = ['https://www.youtube.com/feed/subscriptions']
