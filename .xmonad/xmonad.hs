...
main = do
    ...
    xmproc <- spawnPipe "xmobar /home/solus/.config/xmodar/xmobarrc"
...
myStartupHook = do
          ...
          spawnOnce "feh --randomize --bg-fill /run/media/solus/hdd/Pictures/wallpapers/* --restore &" 
          spawnOnce "compton --config /home/solus/.config/compton.conf &" 
          --setWMName "LG3D"
...
myKeys =
    ...
    -- Layouts
        ...
        , ("M1-<Return>", sendMessage (Toggle NBFULL) >> sendMessage ToggleStruts) -- Toggles noborder/full
    ...
    -- Multimedia Keys
        ...
        , ("M-<F2>", spawn "amixer -q set Master 2%- unmute")
        , ("M-<F3>", spawn "amixer -q set Master 2%+ unmute")
        , ("M-<F4>", spawn "amixer -q set Master toggle")
...
myWorkspaces = clickable . (map xmobarEscape) 
				$ ["\61563", "\61728", "\61729", "\62056", "\61574", "\61465"]
	where                                                                      
...
myLayoutHook = avoidStruts $ mouseResize $ windowArrange $ T.toggleLayouts floats $ 
             ...
             where 
                 myDefaultLayout = smartBorders monocle ||| tall ||| grid ||| floats ||| threeCol ||| threeRow ||| oneBig ||| space
